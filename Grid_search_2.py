...
# Step 4: Define the Custom Moving Average Model
...
# Step 5: Integrate the Custom Model with GridSearchCV
...
# Use TimeSeriesSplit for cross-validation due to the sequential nature of time series data
